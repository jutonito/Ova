...
export class MenuComponent {
  ...
  public texts : string[] = [
    ...
    "Me presento, soy Güiro, soy un investigador novato, y necesitaré de tu ayuda para mejorar mis habilidades",
    "En este caso estoy investigando a la revista 'Rastros Rostros', esta parece ser un gran recurso para aprender gran cantidad de temas interesantes",
